    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
           ...
           <div className="flex items-center gap-4 bg-[#111] border border-white/10 p-2 w-fit rounded-lg">
            <Button
              variant="ghost"
              size="icon"
            ...
            <span className="w-8 text-center text-white font-bold">{isOutOfStock ? 0 : quantity}</span>
            <Button 
              variant="ghost"
              size="icon"
              onClick={() => handleQuantityChange(quantity + 1)} 
